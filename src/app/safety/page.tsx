...
export default function SafetyRoute() { return <LegalPage eyebrow="Safety Policy" title="Clear terms. Safe work. Professional conduct." description="Standards for lawful, brand-safe, consent-based creator marketing, livestream work, and professional campaign behaviour." summary="Alina Popova Studio supports only lawful, brand-safe, consent-based creator marketing and livestream work. We do not support adult, obscene, illegal, exploitative, coercive, unsafe, or unpaid commercial creator work." sections={sections} meaning={meaning} />; }
