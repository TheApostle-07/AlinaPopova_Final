...
export default function RefundsPage() { return <LegalPage eyebrow="Refunds" title="Refund & Cancellation Policy" description="How cancellations, rescheduling, creator bookings, campaign planning, and delivered work are handled." summary="Creator applications are free. Company refunds depend on the written proposal, payment stage, creator booking, planning already completed, content created, live sessions scheduled, and services delivered." sections={sections} meaning={meaning} />; }
