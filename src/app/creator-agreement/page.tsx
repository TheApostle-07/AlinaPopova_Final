...
export default function CreatorAgreementPage() { return <LegalPage eyebrow="Creator Agreement" title="Creator Agreement Summary" description="A simple explanation of how creator applications, selection, training, opportunities, payouts, and content usage work." summary="Applying is free and does not guarantee selection, work, or income. Paid opportunities, if available, are shared with written scope, payout, usage rights, and acceptance before work begins." sections={sections} meaning={meaning} />; }
